                ...
                <div className="project-box-wrapper">
                    <div className="project-box" style="background-color: #e9e7fd;">
                        ...
                        <div className="box-progress-wrapper">
                            <p className="box-progress-header">Progress</p>
                            <div className="box-progress-bar">
                                <span className="box-progress" style="width: 50%; background-color: #4f3ff0"></span>
                            </div>
                ...
                <div className="project-box-wrapper">
                    <div className="project-box">
                        ...
                        <div className="box-progress-wrapper">
                            <p className="box-progress-header">Progress</p>
                            <div className="box-progress-bar">
                                <span className="box-progress" style="width: 80%; background-color: #096c86"></span>
                            </div>
                ...
                <div className="project-box-wrapper">
                    <div className="project-box" style="background-color: #ffd3e2;">
                        ...
                        <div className="box-progress-wrapper">
                            <p className="box-progress-header">Progress</p>
                            <div className="box-progress-bar">
                                <span className="box-progress" style="width: 20%; background-color: #df3670"></span>
                            </div>
                ...
                <div className="project-box-wrapper">
                    <div className="project-box" style="background-color: #c8f7dc;">
                        ...
                        <div className="box-progress-wrapper">
                            <p className="box-progress-header">Progress</p>
                            <div className="box-progress-bar">
                                <span className="box-progress" style="width: 60%; background-color: #34c471"></span>
                            </div>
                            <p className="box-progress-percentage">60%</p>
                        </div>
                        <div className="project-box-footer">
                ...
                <div className="project-box-wrapper">
                    <div className="project-box" style="background-color: #d5deff;">
                        ...
                        <div className="box-progress-wrapper">
                            <p className="box-progress-header">Progress</p>
                            <div className="box-progress-bar">
                                <span className="box-progress" style="width: 40%; background-color: #4067f9"></span>
                            </div>
